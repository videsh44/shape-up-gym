const ErrorToast = ({
  ...
  return (
    <div
      className={`bg-${color}-600 shadow-lg mx-auto w-96 max-w-full text-sm pointer-events-auto bg-clip-padding rounded-lg block mb-3`}
      id="static-example"
      role="alert"
      aria-live="assertive"
      aria-atomic="true"
    ...
    >
      <div className="bg-red-600 flex justify-between items-center py-2 px-3 bg-clip-padding border-b border-red-500 rounded-t-lg">
        ...
        <div className="flex items-center">
          <p className="text-white opacity-90 text-xs">{secondaryText}</p>
          <button
